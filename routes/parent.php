...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['ParentMiddleware']], function () {
        ...
        Route::get('parent-examination-online/{id}', ['as' => 'parent_exam_online', 'uses' => 'Parent\SmParentPanelController@onlineExamination'])->middleware('userRolePermission:parent_exam_online');
