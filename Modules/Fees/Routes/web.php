...
Route::group(['middleware' => ['subdomain']], function () {
    Route::prefix('fees')->middleware('auth')->group(function () {
        ...
        Route::get('fees-invoice-datatable', ['as' => 'fees.fees_invoice_datatable', 'uses' => 'FeesController@feesInvoiceDatatable1'])->middleware('userRolePermission:fees.fees_invoice_datatable');
