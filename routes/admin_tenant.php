...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
       ...
       //Route::get('create-certificate', 'Admin\AdminSection\SmStudentCertificateController@createCertificate')->name('create-certificate');
        ...
        Route::get('student-admission', ['as' => 'student-admission', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@index'])->middleware('userRolePermission:student-admission');
        ...
        //Custom Field Start
        Route::get('student-registration-custom-field','SmCustomFieldController@index')->name('student-registration-custom-field')->middleware('userRolePermission:student-registration-custom-field');
