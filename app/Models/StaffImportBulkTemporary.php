...
class StaffImportBulkTemporary extends Model
{
    use HasFactory;
    protected $fillable = [
        "user_id","staff_id", "role", "department", "designation", "first_name", "last_name", "fathers_name", "mothers_name", "date_of_birth", "date_of_joining", "email", "gender_id", "mobile", "emergency_mobile",
